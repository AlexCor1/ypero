...
<section class="max-w-2xl mx-auto px-6 pt-16 pb-24">
	...
	<div class="glass-card rounded-xl p-6">
		...
		{#if $isValidated}
			<!-- Download button -->
			<div class="flex items-center justify-between p-4 rounded-xl bg-primary/5 mb-8" style="border: 1px solid rgba(52, 254, 160, 0.1);">
				<div class="flex items-center gap-3">
					<div class="w-10 h-10 rounded-lg bg-primary/15 flex items-center justify-center shrink-0">
						<span class="material-symbols-outlined text-primary">download</span>
					</div>
					<div>
						<p class="text-sm font-semibold">Ypero v1.0</p>
						<p class="text-xs text-on-surface-variant">Windows · macOS · Linux</p>
					</div>
				</div>
				<button
					disabled
					class="bg-primary text-on-primary px-5 py-2 rounded-xl font-bold text-sm disabled:opacity-60 inline-flex items-center gap-1.5"
				>
			...
			<p class="text-xs text-on-surface-variant mb-6 flex items-center gap-1.5">
				<span class="material-symbols-outlined text-sm">info</span>
				Desktop app coming soon. You'll be notified at {$authUser?.email} when it's ready.
			</p>
				...
				<div class="flex gap-4">
					...
					<div class="pb-6">
						...
						<p class="text-xs text-on-surface-variant mt-1 leading-relaxed">
							Download the bot from the link above. Open it and sign in with the same email and password you used to create this account. Your validated status syncs automatically.
						</p>
					</div>
				</div>
